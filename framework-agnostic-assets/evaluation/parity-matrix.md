...
|---|---|---|---|---|---|---|---|---|
| S1 登录与会话恢复 | `framework-agnostic-spec/requirements/s1-login-session-restore.md` | in-progress | in-progress | planned | `2026-03-15-S1-kmp-login-session-restore.md`, `2026-03-15-S1-design-backfill.md` | none | `S1-login-and-session-restore.md`, `2026-03-15-S1-figma-backfill-brief.md`, `:shared-domain:allTests`, `:shared-data:allTests`, `:androidApp:assembleDebug` | KMP 已启动真实切片；主壳落点使用 `Chat List Entry Shell`。当前已补 repo 内 Figma backfill brief，下一步是补真实 frame/node handoff、设备验收和 CJMP 对齐 |
